...
The median values of salaries of all star's has always been higher than those of non-allstar's.
However, the varaince in salaries of all star's has been so great that it is hard to directly compare with the salaries of
non-all star's. 
Thus, we need to be careful to firmly say that all star's salaries has always been higher than non-all star's.

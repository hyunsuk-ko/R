...
awt %>%
  pivot_longer(cols=starts_with("all_n_"),names_to="wait_interval",names_prefix="all_n_",values_to="n") %>%
  select(airport,terminal,date,hour,wait_interval,n,everything())
